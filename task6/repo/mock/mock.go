...
//
//	mockgen -source=userRepo.go -destination=mock/mock.go
//
...
func (m *MockUserRepository) Create(arg0 dto.User) (int, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) FindByID(id int) (dto.User, error) {
	m.ctrl.T.Helper()
